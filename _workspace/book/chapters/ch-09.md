...
---
<!-- 소스 포스트: "번아웃을 한 번에 해결할 수 있는 방법은 성과다", "당신은 얼마나 책임 지고 있나요? (feat. Mandate Levels)" -->
<!-- spec 커버리지:
  - [x] 핵심 논지: 번아웃의 근본 원인은 성과의 부재
  - [x] 도입: "그러다가 번아웃 와요" — 통념에 대한 도전
  - [x] 전개1: 성과가 번아웃을 이긴다, 능력 범위(Circle of Competence), 7가지 이점(핵심 4개로 압축), FOMO 간략 언급
  - [x] 전개2: Mandate Levels — A/D/G/I 중심 핵심 전환점 설명, 수평적 관계 vs 수직적 의사결정
  - [x] 마무리: 2막 수렴 + 3막(제품/외부) 전환
  - [x] 전환 지침: Ch.08(일의 구조)에서 이어받기, Ch.10(제품 철학)으로 넘기기
  - [x] 톤: 경어체(~해요) → 책의 톤(~다)으로 통일
  - [x] Mandate Levels 핵심 전환점 중심 서술 (9단계 전부 나열하지 않음)
  - [x] "야근이 당연하다"로 읽히지 않도록 주의 (휴식 필요성 인정)
  - [x] FOMO 간략 언급
  - [x] 예상 분량: 약 4,000자 수준
-->
