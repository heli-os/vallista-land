...
---
<!-- 소스 포스트: 공정하다는 느낌은 결과가 아니라 과정에서 온다, 명령이 아니라 장면을 보여줘라 -->
<!-- 간접 참조: 과정을 디자인하는 사람과 결과를 만드는 사람 -->
<!-- spec 커버리지:
  - 핵심 논지(절차공정성 + 장면 매니지먼트): ✅
  - 도입(연봉 협상 눈짓 장면): ✅
  - 전개1(톰 타일러 절차공정성, 스타트업 함정, 타운홀, 신뢰=구조): ✅
  - 전개2(아이 장난감 메타포, 외부/내부 동기, 코드 리뷰 대비, 실수 체험 기술): ✅
  - 마무리(존재감 사라짐 = 최고 성과, 다음 챕터 전환): ✅
  - 전환 지침(Ch.06→Ch.07 연결, Ch.07→Ch.08 전환): ✅
  - "공정함은 정답이 아니라 태도" 메시지: ✅
  - 번호 에세이 형식 탈피, 책의 논증 흐름으로 재구성: ✅
-->
