...
---
<!-- 소스 포스트: 미션 선언문이라는 허상, 여섯 가지 질문에 답할 수 있는가 -->
<!-- spec 커버리지:
- [x] 핵심 논지: 미션 선언문의 허상, 여섯 가지 질문, 80%+100% 헌신 논리
- [x] 도입: 로비의 액자 장면 + 던더 미플린 반전
- [x] 전개1: 미션 선언문 실패 이유 (욕심, 과정 문제, 대화를 끝내는 도구)
- [x] 전개2: 다섯 명의 리더 에피소드 + 여섯 개의 문 메타포 + 집중의 문 강조
- [x] 왜 답하지 못하는가: 진짜 대화 부족, 마케팅적 접근, 시간 부족
- [x] 정확함보다 헌신: 80%/100% 논리
- [x] 마무리: 액자 vs 대화 + 다음 챕터(피드백)로의 전환
- [x] 전환 지침: Ch.04에서 이어받기(조직의 리더 -> 무엇에 합의할 것인가), Ch.06으로 넘기기(명료함 유지 -> 불편한 말)
- [x] 주의사항: 렌시오니 과의존 방지(개인 경험 중심), 던더 미플린 도입에서만 사용, 집중의 문에 초점
-->
