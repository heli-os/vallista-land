...
---
<!-- 소스 포스트: [볼타 이야기] 결국 B2B는 잘 팔면 되는 거 아닌가?, 프로덕트에서 플레이어를 떼어내는 용기 -->
<!-- spec 커버리지:
- [O] 핵심 논지: B2B 고객 효용 중심, 사용자를 붙잡지 않는 용기, 작은 팀의 제품 철학
- [O] 도입 — "잘 팔면 되는 거 아닌가?" 질문과 프랑켄슈타인 제품 경고
- [O] 전개1 — 사용자를 붙잡지 않는 용기: 에고 비판, 조연 메타포, 빈 화면의 의미
- [O] 전개2 — 떠났다가 돌아오게 하는 것: 넷플릭스 vs 책, 워프 존, 자기 의지의 참여
- [O] 마무리 — 2막 원칙의 제품 반영, 작은 팀의 철학적 차별점
- [O] 전환: Ch.09(팀 내부 운영 완결) → Ch.10(외부 결과물) → Ch.11(AI 시대 구조적 우위)
- [O] SLG/PLG 구분 간략 처리
- [O] 게임/애니메이션 사례와 B2B SaaS의 자연스러운 연결
- [O] 예상 분량: 약 4,500자 부합
-->
