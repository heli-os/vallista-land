...
---
<!-- 소스 포스트: 빨라진 실행, 느려진 팀 — 생산성의 역설 / [볼타 이야기] 볼타 팀은 이렇게 일합니다 -->
<!-- spec 커버리지:
- [x] 도입: 스프린트가 끝났다, 개발자들은 할 일이 없다
- [x] 전개 1: How 비용 0 수렴, What 비용 변화 없음, 비대칭 역설
- [x] 전개 1: 기업의 두 가지 선택지 (병목 충원 vs 개발자 감축), b가 쉬운 이유
- [x] 전개 2: What을 나눔 — 고객 문의, 벤치마크, 프로토타이핑
- [x] 전개 2: 1/3 법칙 교차 운영 (S1/S2/S3 도식 포함)
- [x] 전개 2: 직관 훈련 4가지 (외부 고객, 내부 고객, 시장, 예상치 못한 사용)
- [x] 전개 2: 탑다운 사고, 데이터보다 직관 우선 논거
- [x] 마무리: 더 잘 정의하는 팀
- [x] 전환: Ch.07에서 이어받기 (사람 → 일의 구조)
- [x] 전환: Ch.09로 넘기기 (실행 구조 → 번아웃과 성과)
- [x] 주의사항: AI 시대 전망은 Ch.11로 미룸
- [x] 주의사항: "신입 PM은 없다" 맥락 보강
- [x] 주의사항: 직관 훈련 4가지 핵심 활용 (에필로그에서는 요약만)
-->
