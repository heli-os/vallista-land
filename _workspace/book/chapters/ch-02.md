...
---
<!-- 소스 포스트: 같이 일한다는 것의 진짜 의미, 팀에 '우리다움'이 없으면 논의는 시작되지 않는다 -->
<!-- spec 커버리지:
  - [x] 핵심 논지: 같은 불확실성 안에 서는 것 / 관계의 밀도 / 우리다움
  - [x] 도입: 카페에서 시작된 회사 장면
  - [x] 전개 1: 존속가치 vs 청산가치, 투자자의 믿음, 복지의 본질, 일상의 태도
  - [x] 전개 2: 회의실 침묵, 확신의 부재, 우리다움이 발언의 기준점, 과거 발언 되짚기
  - [x] 마무리: "서로를 대했던 방식은 남는다" + 채용 질문으로의 전환
  - [x] 전환 지침(이전): Ch.01의 구조적 선택에서 관계적 본질로 이동
  - [x] 전환 지침(다음): 관계의 본질 → 누구와 함께할 것인가(채용)
  - [x] 주의: 번호 형식 미사용, 퍼실리테이션은 보조적 언급, 초기/신규 멤버 긴장은 미언급
-->
