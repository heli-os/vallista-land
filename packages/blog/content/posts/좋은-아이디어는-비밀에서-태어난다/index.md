...
하지만 실제로는 반대의 일이 일어난다. 생각을 많이 할수록 안전한 방향으로 수렴한다. 왜냐하면 "생각한다"는 행위 자체가 이미 검증의 프레임 안에서 작동하기 때문이다. "이건 될까?", "사람들이 좋아할까?", "말이 되는 이야기일까?" 같은 질문들이 자동으로 필터가 되어, 조금이라도 위험해 보이는 것을 걸러낸다. 남는 것은 누구도 싫어하지 않지만, 누구도 열광하지 않는 것들이다.
