...
이 문장이 어딘가 낯익다면, 당연하다. 거의 모든 기업의 미션 선언문이 이런 형태이기 때문이다. "세계적인", "주주 가치", "가치 창출", "혁신" 같은 단어가 많이 들어갈수록 좋은 선언문이라는 믿음이 있었다. 하지만 실제로 이 단어들이 많아질수록, 그 문장은 어떤 회사에나 적용 가능한 범용 문구가 되어버린다.
