...
최근 AI 에이전트의 인지 구조를 분석한 [CoALA(Cognitive Architectures for Language Agents)](https://dataportal.kr/Agentic-AI-논문-읽기-CoALA-언어-에이전트를-위한-인지-아키텍처/)라는 논문을 읽었다. 인간의 기억 체계를 빌려와 에이전트를 설계하는 프레임워크였는데, 기억을 네 가지로 나눈다. 지금 이 순간 쓰이는 정보를 담는 작업 기억, 과거 경험을 저장하는 일화 기억, 세계에 대한 사실을 보관하는 의미 기억, 그리고 "어떻게 하는지"를 담는 절차 기억.
